...
namespace Calculator
{
    ...
    {
        public double Sum(double a, double x)
        {
            a += x;
            return a;
        }    
        public double Substract(double a, double x)
        {
            a -= x;
            return a;
        }
        ...
        public double Divide(double a, double x)
        {
            if (x == 0)
        ...
        public string Equals(string operation)// как быть с этим методом??? как он должен выглядеть?
        {
            operation = null;
            return operation;
        }
